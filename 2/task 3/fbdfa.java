...
public class fbdfa {
    ...
    public fbdfa(int[][] states, boolean[]accept, String[] outputs){
        this.states = states;
        this.accept = accept;
    ...
    public static void main(String[]args){
        fbdfa my = new fbdfa("0,0,1,00;1,2,1,01;2,0,3,10;3,3,3,11#0,1,2");
        System.out.println(my.run("1011100"));
        fbdfa myfbda = new fbdfa("0,0,0,00;1,1,1,11#1");
